		...
		'uam-estudiantes': (
			<ProjectDetailContainer>
				...
				<ProjectDetailSplit>
					...
					<GlassCard>
						<ColorCard color='magenta' marker={true} />
						<TextGroup>
			...
			<ProjectDetailContainer>
				...
				<ProjectDetailSplit>
					...
					<GlassCard>
						...
						<TextGroup>
							<Text>
								This mobile app allows the users to find a personal trainer that will remotely monitor their training progress within the app
								trough a large database of pre-defined exercises that a trainer can use to build a complete plan.
							</Text>

							<Text>
								The app guides you through the exercise with a short instructional video as well as it monitors and applies restraints set by
								your trainer.
							</Text>

							<Text>
								The monitoring can be done using video-calls/recordings to send to your trainer, or trough the plan metadata when you finish it.
							</Text>
						</TextGroup>
					</GlassCard>
				</ProjectDetailSplit>
				...
				<ProjectDetailSplit>
					...
					<GlassCard>
						...
						<TextGroup>
							...
							<Text>Registration for trainers requires manual review from the human resources team to ensure proper certifications are met.</Text>
			...
			<ProjectDetailContainer>
				...
				<ProjectDetailSplit>
					...
					<GlassCard>
						...
						<TextGroup>
							...
							<Text>
								Students can ask for an immediate lesson and wait for a match, or program a lesson to the future. While waiting for a lesson to
								start they have a pre-programmed activity to do in the meantime.
							</Text>

							<Text>Teachers can set their schedule and will receive notifications on students searching for classes if they are online.</Text>
						</TextGroup>
					</GlassCard>
				</ProjectDetailSplit>
				<Title>Architecture</Title>
				...
				<ProjectDetailSplit>
					<GlassCard>
						...
						<TextGroup>
							<Text>
								There is a platform to manage students, teachers, exercises and classes as well as to provide support for any issues that can
								happen with the service.
							</Text>
			...
			<ProjectDetailContainer>
				...
				<ProjectDetailSplit>
					...
					<GlassCard>
						...
						<TextGroup>
							<Text>
								This interactive web allows you to dynamically search trough American Language Academy's courses and change parameters within
								each course to find a suitable course.
							</Text>
						</TextGroup>
					</GlassCard>
				</ProjectDetailSplit>
				...
				<ProjectDetailSplit>
					<GlassCard>
						...
						<TextGroup>
							<Text>
								For this to work, the front end is connected to a Strapi v3 server containing all the courses with their parameters so that the
								client can keep the data updated and relevant without a programmer's input.
							</Text>
						</TextGroup>
					</GlassCard>
					<img src={`/projects/arch/control-panel.png`} alt={`Control Panel`} />
